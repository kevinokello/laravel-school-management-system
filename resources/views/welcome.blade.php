                            ...
                            <ul class="row">
                                <li class="col-md-3">
                                    <div class="wm-courses-popular-wrap">
                                        <figure>
                                            <a href="#"><img src="front/extra-images/papular-courses-1.jpg"
                                                    alt="" />
                                ...
                                <li class="col-md-3">
                                    <div class="wm-courses-popular-wrap">
                                        <figure>
                                            <a href="#"><img src="front/extra-images/papular-courses-2.jpg"
                                                    alt="" />
                                                <span class="wm-popular-hover">
                                                    <small>see course</small>
                                                </span>
                                ...
                                <li class="col-md-3">
                                    <div class="wm-courses-popular-wrap">
                                        <figure>
                                            <a href="#"><img src="front/extra-images/papular-courses-3.jpg"
                                                    alt="" />
                                                <span class="wm-popular-hover">
                                                    <small>see course</small>
                                                </span>
                                ...
                                <li class="col-md-3">
                                    <div class="wm-courses-popular-wrap">
                                        <figure>
                                            <a href="#"><img src="front/extra-images/papular-courses-4.jpg"
                                                    alt="" />
                                                <span class="wm-popular-hover">
                                                    <small>see course</small>
                                                </span>
