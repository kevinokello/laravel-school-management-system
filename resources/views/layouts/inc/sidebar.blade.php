          ...
          <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
            ...
            <li class="nav-item {{ Request::is('dashboard') ? 'active' : '' }}"><a href="{{ url('dashboard') }}"><i
              ...
              <li
               ...
               <li class="nav-item {{ Request::is('inventory/units') || Request::is('inventory/categories') || Request::is('inventory/stock/add') ? 'open' : '' }}">
                          <a href="{{ url('student/add-student') }}"><i class="icon-ios-albums-outline"></i><span data-i18n="nav.menu_levels.main"
                                  class="menu-title">Inventory</span></a>
                          <ul class="menu-content">
                              <li>
                                  <a href="{{ url('inventory/units') }}" data-i18n="nav.menu_levels.second_level" class="menu-item {{ Request::is('inventory/units') ? 'active' : '' }}">Manage Units</a>
                              </li>
                              <li>
                                  <a href="{{ url('inventory/categories') }}" data-i18n="nav.menu_levels.second_level" class="menu-item {{ Request::is('inventory/categories') ? 'active' : '' }}">Manage Categories</a>
                              </li>
                               ...
                               <li>
                                  ...
                                  <ul class="menu-content">
                                      <li>
                                          <a href="{{ url('inventory/supplier/add') }}" data-i18n="nav.menu_levels.second_level_child.third_level"
                                              class="menu-item">Add supplier</a>
                                      </li>
                                          <li>
                                          <a href="{{ url('inventory/supplier/all') }}" data-i18n="nav.menu_levels.second_level_child.third_level"
                                              class="menu-item">View Suppliers</a>
                                      </li>
                            ...
                            <li class="nav-item  {{ Request::is('inventory/stock/add') ? 'open' : '' }}">
                                  <a href="#" data-i18n="nav.menu_levels.second_level_child.main"
                                      class="menu-item">Manage stock</a>
                                  <ul class="menu-content">
                                         <li>
                                          <a href="{{ url('inventory/stock/add') }}" data-i18n="nav.menu_levels.second_level_child.third_level"
                                              class="menu-item {{ Request::is('inventory/stock/add') ? 'active' : '' }}">Add Stock</a>
                                      </li>
                                           <li>
                                          <a href="{{ url('inventory/stock/all') }}" data-i18n="nav.menu_levels.second_level_child.third_level"
                                              class="menu-item">All Stock</a>
                                      </li>
                                      <li>
                              ...
                              <li>
                                  ...
                                  <li>
                                  <a href="#" data-i18n="nav.menu_levels.second_level_child.main"
                                      class="menu-item">Manage invoice</a>
                                  <ul class="menu-content">
                                      <li>
                                          <a href="#" data-i18n="nav.menu_levels.second_level_child.third_level"
                                              class="menu-item">All</a>
