...
@section('content')
 ...
 <div class="page-content">
    ...
    <a href="{{ url('inventory/purchase/add') }}" class="btn btn-dark btn-rounded waves-effect waves-light" style="float:right;"><i class="fas fa-plus-circle"> Add Purchase </i></a> <br>  <br>
